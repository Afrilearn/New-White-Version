  ...
  return (
    <div className={styles.policymainwrapper}>
        <div className={styles.policyheader}>
            <h1>Welcome to the Afrilearn's Terms of Use (“Notice”).
        ...
        <div className="row">
          ...
          <div className="col-md-12">
            <div className={`${styles.wrapper} content`}>
              <h3>Welcome to the Afrilearn's Terms of Use (“Notice”).</h3>

              <h1>Contact Details</h1>
              <p>
              www.ulesson.com (“uLesson,” “Website,” “We,” “Us,” or “Our”) is a platform built to host, manage, and deploy educational content to learners via smartphones, tablets, and computers with marginal concern for internet limitations and costs.
                  <br/>
                  <br/>
                The Website is intended to identify and promote the range of services We can offer to Our clients and to provide details as to how We can be contacted. For the purpose of these Terms of Use (“Terms,” or “Agreement”), along with any amendments, “You,” “Your,” or “User” refer to the person visiting, accessing, browsing through, and/or using Our Website/Application (“Services”) or using any storage or transmitting device (“Products”) provided by us at any point in time.
                <br/>
                  <br/>
                Please read these Terms and Our privacy notice (“Privacy Notice”) with respect to the access and use of Our Services and Products carefully before using the Services or Products. If You do not agree with the Terms or the Privacy Notice, please do not use Our Services or avail of the Products. In the event of any discrepancy between the Terms and any other policies with respect to the Services or Products, the provisions of the Terms shall prevail.
                <br/>
                  <br/>
                Also, note that the headings of each section in these Terms are only for the purpose of organizing the various provisions under these Terms in an orderly manner. These headings shall not be used to interpret the provisions contained under them in any manner. Further, the headings have no legal or contractual value.
              </p>
              <h1>MINIMUM AGE</h1>
             
              <p>
              Our Services and Products are only available to persons above the age of 18, if You are below this age, You must obtain permission from Your parent(s) or guardian before accessing this Website. By signing up on this Website, You warrant that You have obtained such permission.
              </p>
              <h1>ACCEPTANCE OF TERMS</h1>
              <p>
              By signing up for Our services, You accept and agree to be bound and abide by these Terms and Our Privacy Notice. If You do not want to agree to these Terms and/or the Privacy Notice, You must not sign up for Our services. If you are acting on behalf of a minor, the minor is also bound by these Terms. You are, therefore, advised to read these Terms carefully, as Your use, access, or browsing of Our Services or Products, with or without payment and with or without a subscription, through any means shall signify Your acceptance of the Terms and Your agreement to be legally bound by the same.
                <br/>
                <br/>
              When using services offered through uLesson’s third-party service providers, such as email, You will be subject to Terms posted by these third-party service providers. Registration for any of Our Services or Products signifies Your agreement to those additional Terms.
              <br/>
                <br/>
              You may receive a written copy of this Agreement by emailing us at: help@ulesson.com with the Subject: Request for Terms of Service Agreement. In addition, when using particular uLesson Services, You and uLesson shall be subject to any posted guidelines or rules applicable to such services that may be posted from time to time. All such guidelines or rules are hereby incorporated by reference into the Terms.
              </p>
